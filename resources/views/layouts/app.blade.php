...
<head>
    ...
    <link rel="icon" href="{{ asset('images/icons/LOGOICOAIE.ico') }}">
...
<body>
    <div id="app">
    @if (Auth::check())
        <nav class="navbar navbar-expand-md navbar-light navbarverde  shadow-sm">
        @else
        <nav class="navbar navbar-expand-md navbar-light navbarverde shadow-sm">
        @endif    
        <img src="{{ asset('/images/icons/LOGOAIEICO.ico') }}" width="70" height="70" class="d-inline-block align-top" alt="">
        ...
        <a class="navbar-brand" href="{{ url('/home') }}">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a class="btn btn-warning btn-rounded btn-lg float-right" href="{{ route('testigos.index') }}"> {{ __('Gestion de Testigos') }}</a>  
